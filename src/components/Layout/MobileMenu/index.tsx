...
import {
  ...
  MegaphoneIcon as FilledMegaphoneIcon,
...
const MobileMenu = ({
  ...
  const menuLinks: MenuLink[] = [
    ...
    {
      href: '/status',
      content: intl.formatMessage(menuMessages.status),
      svgIcon: <SignalIcon className="mr-3 h-6 w-6" />,
      svgIconSelected: <FilledSignalIcon className="mr-3 h-6 w-6" />,
      activeRegExp: /^\/status/,
    ...
    },
    {
      ...
      content: intl.formatMessage(menuMessages.broadcast),
      svgIcon: <MegaphoneIcon className="mr-3 h-6 w-6" />,
      svgIconSelected: <FilledMegaphoneIcon className="mr-3 h-6 w-6" />,
      activeRegExp: /^\/users\/broadcast/,
